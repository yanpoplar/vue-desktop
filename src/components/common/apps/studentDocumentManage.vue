    ...
    <div class="page coursemanage">
        ...
        <div class="page-main">
            <div class="con-header">
                <div class="btn-add">
                    <el-button type="primary" icon="el-icon-plus" @click="addDocument">新建档案</el-button>
                    <el-button type="primary" icon="iconfont icon-piliangdaoru" @click="batchImport">批量导入</el-button>
                </div>
            ...
            <div class="con-main">
                <el-table :data="tableData" height="100%" border style="height:100%;border-radius:3px;">
                    ...
                    <el-table-column label="现居住地" prop="address">
                    </el-table-column>
                    <el-table-column label="政治面貌" prop="politicsStatus">
                    </el-table-column>
                    <el-table-column label="联系电话" prop="phone">
                    </el-table-column>
                    <el-table-column label="身份证号" prop="IDNumber">
                    </el-table-column>
                    <el-table-column label="毕业学校" prop="school">
                    </el-table-column>
                    <el-table-column label="账号ID" prop="account">
                    </el-table-column>
                    <el-table-column label="" width="120">
                        <template slot-scope="scope">
                            <el-tooltip class="item" content="重置密码" placement="top">
                                <i class="iconfont icon-liucheng" @click="resetPassword(scope.$index,scope.row)"></i>
                            </el-tooltip>
        ...
        data: function () {
            return {
                ...
                tableData: [{
                        ...
                        stuName: '张琳',
                        stuSex: '女',
                        stuBirthday: '2017.6.5',
                        nation: '汉族',
                        nativePlace: '山西',
                        address: '山西',
                        politicsStatus: '团员',
                        phone: '11012011912',
                        IDNumber: '140181199210202256',
                        school: '太原十六中',
                        account: '110129'
                    },
                    {
